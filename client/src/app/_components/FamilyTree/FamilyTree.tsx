...
export default function FamilyTree({
  ...
  useEffect(() => {
    ...
    const root = d3
      .stratify<Whale>()
      .id((d) => d.whale_id)
      .parentId((d) => d.parent)(familyData);
    ...
    const svg = d3
      ...
      .attr(
        "transform",
        `translate(${width / ((root.height + 1) * 2)}, ${height / 2})`,
      );
    ...
    svg
      ...
      .attr(
        ...
        d3
          .linkHorizontal<
            d3.HierarchyPointLink<Whale>,
            d3.HierarchyPointNode<Whale>
          >()
          .x((d) => d.y)
          .y((d) => d.x),
      );
    ...
    node
      ...
      .attr("fill", (d) =>
        d.data.whale_id === currentWhale
          ? "#B2FF6F"
          : genderColours(d.data.gender ?? "unknown"),
      )
