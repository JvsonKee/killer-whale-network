export const threats = [
  {
    ...
    impact:
      "With less food available, orcas are experiencing malnutrition, weaker immune systems, and higher calf mortality rates. Starving whales are also more susceptible to disease and toxins.",
    solution:
  ...
  },
  {
    ...
    impact:
      "Whales must work harder to communicate and hunt, burning more energy in the process. Increased stress levels can also impact reproduction. In some cases, orcas have been injured or even killed by vessel strikes.",
    solution:
