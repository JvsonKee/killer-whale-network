...
def initialize_ids_and_names(driver, n, cur):
    sections_len = len(
        driver.find_elements(By.XPATH, '//*[@id="mw-content-text"]/div[3]/div')
    )
    ...
    for i in range(1, sections_len + 1):
        curr_letter = driver.find_element(
            By.XPATH, f'//*[@id="mw-content-text"]/div[3]/div[{i}]/div'
        ).text
            ...
            pod_counts.append(
                len(
                    driver.find_elements(
                        By.XPATH, f'//*[@id="mw-content-text"]/div[3]/div[{i}]/ul/li'
                    )
                )
                + 1
            )
    ...
    for i in range(len(pod_indices)):
        for j in range(1, pod_counts[i]):
            id_and_name = driver.find_element(
                By.XPATH,
                f'//*[@id="mw-content-text"]/div[3]/div[{pod_indices[i]}]/ul/li[{j}]/a',
            ).text
...
def navigate_menu(driver, index):
    menu = driver.find_element(
        By.XPATH, "/html/body/div[4]/div[4]/div[1]/header/nav/ul/li[3]/div[1]/a"
    )
    ...
    driver.find_element(
        By.XPATH,
        f"/html/body/div[4]/div[4]/div[1]/header/nav/ul/li[3]/div[2]/ul/li[{index}]/a",
    ).click()
...
def scrape_whale(driver, cur, whale_id):
    gender, birth_year, death_year, mother_id, father_id = (
        None,
        None,
        None,
        None,
...
def scrape_gender(driver):
    ...
    for source in gender_sources:
        try:
            gender = (
                driver.find_element(By.XPATH, f"{source}")
                .text.split(" ", 1)[-1]
                .lower()
            )
...
def scrape_mother_id(driver):
    try:
        mother_elem = driver.find_element(
            By.XPATH,
            '//*[@id="mw-content-text"]/div/aside/section[2]/div/h3 | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/h3',
        )
        if mother_elem.text == "Mother":
            mother_text = driver.find_element(
                By.XPATH,
                '//*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/ul/li/a/u/i/b | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/a/u/b | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/ul/li/a/u/b | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/a/u/i/b | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/a/b/u | //*[@id="mw-content-text"]/div/aside/section[2]/div[1]/div/b/u/a',
            ).text
...
def scrape_father_id(driver):
    try:
        father_elem = driver.find_element(
            By.XPATH, '//*[@id="mw-content-text"]/div/aside/section[2]/div[2]/h3'
        )
        if father_elem.text == "Father":
            father_text = driver.find_element(
                By.XPATH,
                '//*[@id="mw-content-text"]/div/aside/section[2]/div[2]/div/a | //*[@id="mw-content-text"]/div/aside/section[2]/div[2]/div/i/a',
            ).text
